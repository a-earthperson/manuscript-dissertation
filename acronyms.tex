\makeglossaries
\newacronym{af}{AFM}{Alpha Factor Model}
...
\newacronym{bfr}{BFR}{Binomial Failure Rate Model}
\newacronym{bfm}{BFM}{Beta Factor Model}
\newacronym{bics}{BICS}{Boolean Indicated Cut Sets}
\newacronym{bis}{BIS}{Boolean Indicated Sets}
\newacronym{bn}{BN}{Bayesian Network}
\newacronym{bpm}{BPM}{Basic Parameter Model}
\newacronym{bson}{BSON}{Binary-encoded \acrlong{json}}
\newacronym{bwr}{BWR}{Boiling Water Reactor}

\newacronym{cafta}{CAFTA}{Computer Aided Fault Tree Analysis System}
...
\newacronym{di}{DIF}{Diagnostic Importance Factor}

\newacronym{dim}{DIM}{Differential Importance Measure}
...
\newacronym{fv}{FV}{Fussell–Vesely Importance Measure}
...
\newacronym{lerf}{LERF}{Large Early Release Frequency}
...
\newacronym{pim}{IP}{Improvement Potential}
...
\newacronym{pw}{PW}{Prevention Worth}
...
\newacronym{raw}{RAW}{Risk Achievement Worth}
...
\newacronym{rrw}{RRW}{Risk Reduction Worth}
