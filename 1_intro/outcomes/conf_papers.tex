...
\begin{itemize}
    ...
    \item {Model Exchange Methodology Between Probabilistic Risk Assessment Tools: \acrshort{saphire} and CAFTA Case Study}, \acrfull{ans} \acrfull{psa}~\cite{hamza_model_2023}.
...
\begin{itemize}
    % 2024
    \item {Advancing \acrshort{saphire}: Transitioning from Legacy to State-of-Art Excellence}, \acrshort{ans} \acrfull{ars}~\cite{wood_advancing_2024}.
    ...
    \item {Enhancing the \acrshort{saphire} Solve Engine: Initial Progress and Efforts}, \acrshort{ans} \acrshort{ars}~\cite{aras_enhancing_2024}.
...
\begin{itemize}
    ...
    \item {Facilitating PRA Model Accessibility: Model Converter Utility from \acrshort{saphire} to Open-PSA}, \acrshort{ans} \acrshort{psa}~\cite{aras_facilitating_2025}.
