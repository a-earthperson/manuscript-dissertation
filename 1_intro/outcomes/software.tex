\subsection{Software}
The following repositories are maintained under my personal GitHub, and the OpenPRA umbrella, an open–source effort that now comprises over a dozen active contributors from academia and industry.  Unless otherwise noted, my role has been to architect the core infrastructure and mentor fellow student developers; day-to-day development is a shared effort.

\begin{itemize}

    \item {\textbf{\href{https://github.com/a-earthperson/mcSCRAM}{@a-earthperson/mcSCRAM}}: Data-Parallel Monte Carlo Probability Estimation Framework~\cite{earthperson_mcscram}}. The central focus of this dissertation.
