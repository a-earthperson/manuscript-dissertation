...
\centering
\begin{tikzpicture}
\tikzset{canonical/.style={fill=blue!30},myedges/.style={-, >={Stealth[reversed]}, thick},anchored/.style={draw=none, nodes=draw, opacity=0, font=\tiny}}
\graph [layered layout, edges=rounded corners,edge=myedges] {
