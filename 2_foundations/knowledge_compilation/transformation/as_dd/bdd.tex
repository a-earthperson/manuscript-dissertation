...
\node[main node] (A) {a};
\node[main node] (B) [below left=1.6cm of A] {b};
\node[main node] (C) [below right=1.6cm of B, xshift=0.6cm] {c};
\node[terminal node] (T1) [below=1.8cm of C, xshift=-1.2cm] {1};
\node[terminal node] (T0) [right of=T1,node distance=2.8cm] {0};
